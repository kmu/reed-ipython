...
# c.SlurmLauncher.submit_command = traitlets.Undefined

# The slurm delete command ['scancel']
# c.SlurmLauncher.delete_command = traitlets.Undefined

# Extra Slurm options
# c.SlurmLauncher.options = u''

#------------------------------------------------------------------------------
# SlurmControllerLauncher configuration
#------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------
# SlurmEngineSetLauncher configuration
#------------------------------------------------------------------------------
